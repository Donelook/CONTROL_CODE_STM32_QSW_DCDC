...
/* Private defines -----------------------------------------------------------*/
#define NOT_FAULT_1_Pin GPIO_PIN_2
#define NOT_FAULT_1_GPIO_Port GPIOE
#define CS_FAULT_2_Pin GPIO_PIN_4
#define CS_FAULT_2_GPIO_Port GPIOE
#define RESET_INTERLOCK_Pin GPIO_PIN_5
#define RESET_INTERLOCK_GPIO_Port GPIOE
#define CS_OCD_2_Pin GPIO_PIN_9
#define CS_OCD_2_GPIO_Port GPIOF
#define READY_3_Pin GPIO_PIN_10
#define READY_3_GPIO_Port GPIOF
...
#define READY_2_Pin GPIO_PIN_0
#define READY_2_GPIO_Port GPIOB
...
#define NOT_RST_2_Pin GPIO_PIN_8
#define NOT_RST_2_GPIO_Port GPIOE
#define CS_VREF_2_Pin GPIO_PIN_9
#define CS_VREF_2_GPIO_Port GPIOE
#define NOT_FAULT_2_Pin GPIO_PIN_11
#define NOT_FAULT_2_GPIO_Port GPIOE
...
#define NOT_FAULT_4_Pin GPIO_PIN_9
#define NOT_FAULT_4_GPIO_Port GPIOC
#define IMAX2_SUM_Pin GPIO_PIN_8
#define IMAX2_SUM_GPIO_Port GPIOA
#define READY_4_Pin GPIO_PIN_10
#define READY_4_GPIO_Port GPIOA
#define NOT_RST_3_Pin GPIO_PIN_0
#define NOT_RST_3_GPIO_Port GPIOD
