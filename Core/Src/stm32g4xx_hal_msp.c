...
void HAL_ADC_MspDeInit(ADC_HandleTypeDef* hadc)
{
  ...
  /* USER CODE END ADC3_MspDeInit 0 */
    ...
    PB13     ------> ADC3_IN5
    */
    HAL_GPIO_DeInit(GPIOB, CS_VREF_1_Pin|HEATSINK_TEMP_Pin);

    HAL_GPIO_DeInit(GPIOE, PCB_TEMP_Pin|CS_VREF_2_Pin|INPUT_V_ADC_Pin);
  ...
  /* USER CODE END ADC4_MspDeInit 0 */
    ...
    PE14     ------> ADC4_IN1
    */
    HAL_GPIO_DeInit(OUTPUT_V_ADC_GPIO_Port, OUTPUT_V_ADC_Pin);
  ...
  /* USER CODE END ADC5_MspDeInit 0 */
    ...
    PA8     ------> ADC5_IN1
    */
    HAL_GPIO_DeInit(IMAX2_SUM_GPIO_Port, IMAX2_SUM_Pin);
...
void HAL_DAC_MspDeInit(DAC_HandleTypeDef* hdac)
{
  ...
  /* USER CODE END DAC1_MspDeInit 0 */
    ...
    PA5     ------> DAC1_OUT2
    */
    HAL_GPIO_DeInit(GPIOA, IMAX_Pin|IMAX2_Pin);
  ...
  /* USER CODE END DAC2_MspDeInit 0 */
    ...
    PA6     ------> DAC2_OUT1
    */
    HAL_GPIO_DeInit(IMIN_GPIO_Port, IMIN_Pin);
...
void HAL_TIM_MspPostInit(TIM_HandleTypeDef* htim)
{
  ...
  /* USER CODE END TIM2_MspPostInit 0 */
    ...
    PA15     ------> TIM2_CH1
    */
    GPIO_InitStruct.Pin = FAN_PWMA15_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
    GPIO_InitStruct.Alternate = GPIO_AF1_TIM2;
    HAL_GPIO_Init(FAN_PWMA15_GPIO_Port, &GPIO_InitStruct);
